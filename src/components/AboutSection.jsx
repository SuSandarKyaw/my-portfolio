        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gray-800/50 backdrop-blur-lg rounded-3xl p-8 shadow-2xl">
            <h3 className="text-2xl font-bold mb-4 text-cyan-400">
              Hello! I'm Su Sandar Kyaw
            </h3>
            <p className="text-gray-300 leading-relaxed mb-6">
              I am a B.Sc (Hons) Computing graduate from the University of
              Greenwich, specializing in modern frontend engineering. My core
              expertise lies in building scalable, user-centric interfaces with
              React.js, Next.js, and Tailwind CS.
            </p>
            <p className="text-gray-300 leading-relaxed mb-6">
              My professional journey includes a successful transition from an
              intern at MMS Connection to a Junior Frontend Developer at NiT
              College. I’ve contributed to diverse projects ranging from complex
              travel dashboards to official educational websites, always
              prioritizing code quality, performance optimization, and
              responsive design.
            </p>
